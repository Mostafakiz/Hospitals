    ...
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto"> {{trans('Dashboard/main-sidebar-transe.doctors')}}</h4><span
                ...
                {{trans('Dashboard/Doctors.edit_doctor')}}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-200">
                        <div>
                            ...
                            <img style="border-radius:20%"
                                src="{{Url::asset('Dashboard/img/doctors/'.$doctor->image->filename)}}" height="150px"
                                width="150px" alt="">
                            @else
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                <select name="section_id" class="form-control SlectBox">
                                    ...
                                    <option value="{{$section->id}}" {{$section->id == $doctor->section_id ?
