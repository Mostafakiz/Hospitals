...
<aside class="app-sidebar sidebar-scroll">
	<div class="main-sidebar-header active">
		...
		<a class="desktop-logo logo-dark active" href="{{ url('/' . $page='index') }}"><img
				src="{{URL::asset('Dashboard/img/brand/logo-white.png')}}" class="main-logo dark-theme" alt="logo"></a>
	...
	<div class="main-sidemenu">
		...
		<ul class="side-menu">
			<li class="side-item side-item-category">{{trans('Dashboard/main-sidebar-transe.Main')}}</li>
			<li class="slide">
				<a class="side-menu__item" href="{{ url('/' . $page='index') }}"><svg xmlns="http://www.w3.org/2000/svg"
					...
					</svg><span class="side-menu__label">{{trans('Dashboard/main-sidebar-transe.index')}}</span><span
			...
			<!-- <li class="slide">
				<a class="side-menu__item" href="{{ url('/' . $page='icons') }}"><svg xmlns="http://www.w3.org/2000/svg"
					...
					</svg><span class="side-menu__label">{{trans('Dashboard/main-sidebar-transe.sections')}}</span><span
			...
			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg
					...
					</svg><span class="side-menu__label">{{trans('Dashboard/main-sidebar-transe.sections')}}</span><i
			...
			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg
					...
					</svg><span class="side-menu__label">{{trans('Dashboard/Doctors.Doctors')}}</span><i
						class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					<li><a class="slide-item"
							href="{{ route('Doctors.index') }}">{{trans('Dashboard/Doctors.View_all')}}</a></li>
				</ul>
			</li>
			...
			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg
					...
					</svg><span class="side-menu__label">{{trans('Dashboard/main-sidebar-transe.Services')}}</span><i
						class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					<li><a class="slide-item"
					...
					<li><a class="slide-item"
							href="{{ url('/' . $page='rangeslider') }}">{{trans('Dashboard/main-sidebar-transe.ambulance')}}</a>
					</li>
					<li><a class="slide-item"
							href="{{ url('/' . $page='calendar') }}">{{trans('Dashboard/main-sidebar-transe.Ambulance_calls')}}</a>
					</li>
				</ul>
			</li>
			<li class="slide">
